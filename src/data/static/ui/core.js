...
const translations = {
    ru: {
        ...
        uploadResultIdleTitle: "Пока без загрузки",
        uploadResultIdleBody: "Выберите один или несколько файлов и отправьте их на сервер.",
        filesResultIdleTitle: "Пока без проверки",
        filesResultIdleBody: "Откройте папку, скачайте файл или запустите действие из списка.",
        opsecResultIdleTitle: "Пока без отправки",
        ...
        methodSmuggle: "Генерация HTML-артефакта",
        tabRequests: "Запросы",
        ...
        requestBatchDetailsSummary: "Прогон всех методов",
        ...
        requestBatchLegendMatch: "Работает",
        requestBatchLegendIssue: "Не работает",
        ...
        requestPreviewCheckMatch: "Работает",
        requestPreviewCheckMismatch: "Не работает",
        ...
        opsecAdvancedOptions: "Доп. параметры",
        ...
        smuggleProtect: "XOR",
        smuggleProtectHint: "Пароль задаст сервер; используйте XOR только для внутренней lab-проверки.",
        smuggleGenerate: "Сгенерировать",
        smuggleOpen: "Открыть",
        smuggleCopyUrl: "Копировать URL",
        ...
        smuggleYes: "Да (XOR)",
        smuggleNo: "Нет",
        smuggleReady: "Артефакт готов. Проверьте URL и выберите дальнейшее действие.",
        smuggleCopied: "URL артефакта скопирован.",
        smuggleOpened: "Артефакт открыт в новой вкладке.",
        smuggleResultHint: "Одноразовый артефакт: откройте или сохраните его до повторной генерации.",
        smuggleBuilderLabBadge: "Только lab",
        ...
        smuggleBuilderPresetSection: "Шаблон страницы",
        smuggleBuilderPresetLabel: "Режим",
        ...
        smuggleBuilderAdvancedSection: "Текст и защита",
        ...
        smuggleBuilderNoticeLabel: "Показывать пометку lab-only",
        smuggleBuilderPreviewSection: "Превью",
        smuggleBuilderPreviewPreset: "Шаблон",
        smuggleBuilderPreviewDelay: "Автостарт",
        smuggleBuilderPreviewProtected: "XOR + пароль",
        smuggleBuilderDefaultTitle: "Тестовый артефакт готов",
        smuggleBuilderDefaultMessage: "Нейтральный внутренний тестовый артефакт для lab-профиля.",
        smuggleBuilderDefaultCta: "Скачать тестовый артефакт",
        smuggleBuilderNoticePreview: "Только для внутренней лабораторной проверки.",
        opsecWarning: "",
        ...
        notepadUnavailableServer: "Блокнот недоступен: восстановите или переустановите стандартные runtime-зависимости сервера.",
    ...
    en: {
        ...
        uploadResultIdleTitle: "No uploads yet",
        uploadResultIdleBody: "Choose one or more files and send them to the server.",
        filesResultIdleTitle: "No checks yet",
        filesResultIdleBody: "Open a folder, download a file, or run an action from the list.",
        opsecResultIdleTitle: "No transfer yet",
        ...
        methodSmuggle: "Generate an HTML artifact",
        ...
        requestBatchDetailsSummary: "Full method run",
        ...
        requestPreviewCheckMatch: "Works",
        requestPreviewCheckMismatch: "Doesn't work",
        ...
        opsecAdvancedOptions: "Advanced options",
        ...
        smuggleProtect: "XOR",
        smuggleProtectHint: "The server sets the password; use XOR only for internal lab verification.",
        smuggleGenerate: "Generate",
        smuggleOpen: "Open",
        smuggleCopyUrl: "Copy URL",
        smuggleSave: "Save",
        smuggleClose: "Close",
        ...
        smuggleYes: "Yes (XOR)",
        smuggleNo: "No",
        smuggleReady: "Artifact ready. Review the URL, then choose what to do next.",
        smuggleCopied: "Artifact URL copied.",
        smuggleOpened: "Artifact opened in a new tab.",
        smuggleResultHint: "One-shot artifact: open or save it before generating another one.",
        smuggleBuilderLabBadge: "Lab only",
        ...
        smuggleBuilderPresetSection: "Page preset",
        smuggleBuilderPresetLabel: "Preset",
        smuggleBuilderPresetDirect: "Direct download",
        smuggleBuilderPresetManual: "Card + button",
        smuggleBuilderPresetAuto: "Card + auto-start",
        smuggleBuilderAdvancedSection: "Copy and protection",
        ...
        smuggleBuilderNoticeLabel: "Show lab-only marker",
        smuggleBuilderPreviewSection: "Preview",
        smuggleBuilderPreviewPreset: "Preset",
        smuggleBuilderPreviewDelay: "Auto-start",
        smuggleBuilderPreviewProtected: "XOR + password",
        smuggleBuilderDefaultTitle: "Test artifact ready",
        smuggleBuilderDefaultMessage: "Neutral internal test artifact for the lab profile.",
        smuggleBuilderDefaultCta: "Download test artifact",
        smuggleBuilderNoticePreview: "For internal lab verification only.",
        opsecWarning: "",
